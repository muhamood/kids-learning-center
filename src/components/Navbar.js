...
export const Navbar = () => {
  ...
  return (
    <div className="App">
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-2 navbar-expand-lg mb-0 bg-gray-300">
        <div className="container px-4 mx-auto my-1 flex flex-wrap items-center justify-between">
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-twitter text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Our Staff</span>
                </a>
              </li>
              <li className="nav-item">
                <a
              ...
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Gallery</span>
                </a>
              </li>
              <li className="nav-item">
                <a
